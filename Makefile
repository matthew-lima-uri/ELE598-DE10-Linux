...
# FORCE the architecture to ARM (Cyclone V)
ARCH		= arm
# FORCE the cross-compiler toolchain
CROSS_COMPILE	= /home/frothiestma2/Projects/gcc-linux-de10/bin/arm-linux-gnueabihf-
